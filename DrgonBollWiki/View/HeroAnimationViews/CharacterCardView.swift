...
struct CharacterCardView: View {
    ...
    @Binding var favorites: [DbSwiftDataModel]
    ...
    var body: some View {
        ...
        .task {
            isFavorite = favorites.contains { $0.id == character.id }
...
#Preview {
    ...
    return CharacterCardView(character: character, characterKiColor: .yellow, animation: animation, favorites: .constant([]))
