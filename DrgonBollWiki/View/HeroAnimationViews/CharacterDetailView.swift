...
//    init(singleCharacterViewModel: Environment<SingleCharacterViewModel>, selectedCharacter: Binding<Character>, animation: Namespace.ID, showDetails: Binding<Bool>, characterKiColor: Color) {
//        _singleCharacterViewModel = singleCharacterViewModel
//        _showDetails = showDetails
//        self._selectedCharacter = selectedCharacter
//        self.animation = animation
//        self._characterKiColor = State(wrappedValue: .yellow)
//    }
...
#Preview {
    ...
    return CharacterDetailView(showDetails: .constant(true), selectedCharacter: $selectedCharacter, animation: animation)
