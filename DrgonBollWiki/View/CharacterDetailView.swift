...
struct CharacterDetailView: View {
    ...
    init(singleCharacterViewModel: SingleCharacterProtocol, selectedCharacter: Character) {
...
#Preview {
    ...
    return CharacterDetailView(singleCharacterViewModel: MockSingleCharacterDataService(testData: nil), selectedCharacter: selectedCharacter)
