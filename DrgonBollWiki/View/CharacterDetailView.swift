...
struct CharacterDetailView: View {
    ...
    init(singleCharacterViewModel: SingleCharacterProtocol, selectedCharacter: Character, selectedCharacterKiColor: Binding<Color>) {
...
#Preview {
    ...
    return CharacterDetailView(singleCharacterViewModel: MockSingleCharacterDataService(testData: nil), selectedCharacter: selectedCharacter, selectedCharacterKiColor: .constant(Color.yellow))
